...
<head>
    ...
    <script type="text/javascript" src="assets/js/managetvshow.js"></script>
</head>
...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="page-header overlay-gradient" style="background: url(assets/images/posters/movie-collection.jpg);">
            <div class="container">
                <div class="inner">
                    <h2 class="title">Update TV Series</h2>
                </div>
            </div>
        </section>
        <!-- =============== END OF PAGE HEADER =============== -->
            ...
            <div class="container">
                <div class="row">
					...
					%>
                        ...
                        <!-- Start of Contact Form -->
                        <form action="tvseriescontrol" method="post" onsubmit="return validateTVShow()" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-box" type="text" name="txtTVShowID" value="<%=resultSet.getString("tvseries_id")%>"  autocomplete="off" readonly required>
                            </div>

                            <!-- Form Group -->
                            <div class="form-group">
                            	<label for="movie-input-field">Title</label>
                                <input class="form-control input-box" type="text" id="tvshowtitle" name="txtMovieTitle" value="<%=resultSet.getString("name")%>" placeholder="Movie Title" autocomplete="off" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-box" type="text" id="director" name="txtDirector" value="<%=resultSet.getString("director")%>" placeholder="Director" autocomplete="off" required>
                            </div>
                            
                            <!-- Form Group -->
                            <div class="form-group">
                            	<label for="movie-input-field">Production Company</label>
                                <input class="form-control input-box" type="text" id="company" name="txtProductionCompany" value="<%=resultSet.getString("production_company")%>" placeholder="Production Company" autocomplete="off" required>
                            </div>
                            
                            <!-- Form Group -->
                            <div class="form-group">
                            	<label for="movie-input-field">Seasons</label>
                                <input class="form-control input-box" type="text" name="txtSeasons" value="<%=resultSet.getString("seasons")%>" placeholder="No of Seasons" autocomplete="off" required>
                            </div>
                            ...
                            <div class="form-group text-center">
                            	<a href="${pageContext.request.contextPath}/addepisode.jsp?tvseries_id=<%=resultSet.getString("tvseries_id")%>" class="btn btn-main btn-effect">Add New Episode</a>
                                <button class="btn btn-main btn-effect" type="submit" name="btnUpdateTVShow" value="updateTVShow">Update TV Series</button>
                                <button class="btn btn-main btn-effect" type="submit" name="btnDeleteTVShow" onclick="confirmDelete(event)" value="deleteTVShow">Delete TV Series</button>
                            </div>
                        </form>

...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="page-header overlay-gradient" style="background: url(assets/images/posters/movie-collection.jpg);">
            <div class="container">
                <div class="inner">
                    <h2 class="title">Update Episode</h2>
                </div>
            </div>
        </section>
        <!-- =============== END OF PAGE HEADER =============== -->
            ...
            <div class="container">
                <div class="row">
					...
					try{
						...
						String sql ="select path from episodetb where tvshow="+tvShowID+" and season="+season+" and episode="+episode;
					...
					%>
                        ...
                        <form action="tvseriescontrol" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="txtPreviousSeason" value="<%=season%>">
                            <input type="hidden" name="txtPreviousEpisode" value="<%=episode%>">
							
							<!-- Form Group -->
                            <div class="form-group">
                            	<label for="movie-input-field">TV Show ID</label>
                                <input class="form-control input-box" type="text" name="txtTVShowID" value="<%=tvShowID%>" placeholder="TV Show ID" autocomplete="off" readonly>
                            </div>
                            
                            <!-- Form Group -->
                            <div class="form-group">
                            	<label for="movie-input-field">Season</label>
                                <input class="form-control input-box" type="text" name="txtSeason" value="<%=season%>" placeholder="Season" autocomplete="off">
                            </div>
                            
                            <!-- Form Group -->
                            <div class="form-group">
                            	<label for="movie-input-field">Episode</label>
                                <input class="form-control input-box" type="text" name="txtEpisode" value="<%=episode%>" placeholder="Episode" autocomplete="off">
                            </div>
                            
                            <!-- Form Group -->
							<div class="form-group">
								<label for="banner-image-input-field">Current Uploaded Episode File - <%=resultSet.getString(1)%></label>
								<input class="form-control-file" type = "file" name = "episode" id="movie-input-field" accept="video/mp4"/>
							</div>
							
                            <!-- Form Group -->
                            <div class="form-group text-center">
                                <button class="btn btn-main btn-effect" type="submit" name="btnUpdateEpisode" value="updateEpisode">Update Episode</button>
                                <button class="btn btn-main btn-effect" type="submit" name="btnDeleteEpisode" value="deleteEpisode">Delete Episode</button>
                            </div>
                        </form>

...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="page-header overlay-gradient" style="background: url(assets/images/posters/movie-collection.jpg);">
            <div class="container">
                <div class="inner">
                    <h2 class="title">Update Celebrity</h2>
                </div>
            </div>
        </section>
        <!-- =============== END OF PAGE HEADER =============== -->
            ...
            <div class="container">
                <div class="row">
					...
					%>
                        ...
                        <!-- Start of Contact Form -->
                        <form action="celebritycontrol" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-box" type="text" name="txtCelebrityID" value="<%=resultSet.getString("celebrity_id")%>"  autocomplete="off" readonly required>
                            </div>

                            <!-- Form Group -->
                            <div class="form-group">
                            <label for="movie-input-field">Name</label>
                                <input class="form-control input-box" type="text" name="txtCelebName" value="<%=resultSet.getString("name")%>" placeholder="Celebrity Name" autocomplete="off" required>
                            </div>
                            
                            <!-- Form Group -->
                            <div class="form-group mb20">
                            	<label for="movie-input-field">Biography</label>
                                <textarea class="form-control textarea-box" rows="8" name="txtBiography" placeholder="Biography"><%=resultSet.getString("biography")%></textarea>
                            </div>
                            
                            <div class="form-group">
                            	<label for="movie-input-field">Date of Birth</label>
                            	<input class="form-control" type="date" name="CelebDOB" value="<%=resultSet.getString("dob")%>" required pattern="\d{4}-\d{2}-\d{2}" placeholder="Date Of Birth">
							</div>
							
							<div class="form-group">
								<label for="movie-input-field">Gender</label>
                            	<select class="custom-select" name="selectGender">
  									<option selected value="<%=resultSet.getString("gender")%>"><%=resultSet.getString("gender")%></option>

...
<head>
    ...
    <!-- ===== Website Title ===== -->
    <title>Popcorn Time - Search</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="page-header overlay-gradient" style="background: url(assets/images/posters/movie-collection.jpg);">
            <div class="container">
                <div class="inner">
                    <h2 class="title">Search Result for "<%=request.getParameter("search-keyword")%>"</h2>
                </div>
            </div>
        </section>
        <!-- =============== END OF PAGE HEADER =============== -->
            ...
            <div class="container">
                ...
                <%
					try{
						...
						String sql ="select * from movietb where name like '%"+request.getParameter("search-keyword")+"%'";
                        ...
                        <div class="movie-box-2 mb30">
                            <div class="listing-container">
                                ...
                                <div class="listing-image">
                                    ...
                                    <!-- Image -->
                                    <img src="media/movies/posters/<%=resultSet.getString(12)%>" alt="">
                                </div>

                                <!-- Movie List Content -->
                                <div class="listing-content">
                                    <div class="inner">
                                        <h2 class="title"><%=resultSet.getString(2)%></h2>

                                        <p><%=resultSet.getString(3)%></p>

                                        <a href="${pageContext.request.contextPath }/movie?movie_id=<%=resultSet.getString(1)%>" class="btn btn-main btn-effect">details</a>
                                    </div>
                                </div>
                ...
                <%
					try{
						connection = DBConnectUtil.getConnection();
						statement=connection.createStatement();
						String sql ="select * from tvseriestb where name like '%"+request.getParameter("search-keyword")+"%'";
						resultSet = statement.executeQuery(sql);
						while(resultSet.next()){
					%>
                    <!-- Movie List Item -->
                        ...
                        <div class="movie-box-2 mb30">
                            <div class="listing-container">
                                ...
                                <div class="listing-image">
                                    ...
                                    <!-- Play Button -->
                                    <div class="play-btn">
                                        <a href="<%=resultSet.getString(13)%>" class="play-video">
                                            <i class="fa fa-play"></i>
                                        </a>
                                    </div>
                                    
                                    <!-- Image -->
                                    <img src="media/tvshows/posters/<%=resultSet.getString(11)%>" alt="">
                                </div>
                                ...
                                <div class="listing-content">
                                    <div class="inner">
                                        ...
                                        <a href="${pageContext.request.contextPath }/tvshow?tvseries_id=<%=resultSet.getString(1)%>" class="btn btn-main btn-effect">details</a>
                                    </div>
                                </div>
                            </div>
                        </div>

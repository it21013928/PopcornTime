...
<%
	if (session == null 
	|| session.getAttribute("sessionRole") == null 
	|| !(session.getAttribute("sessionRole").equals(request.getParameter("role"))) 
	||!(session.getAttribute("sessionUsername").equals(request.getParameter("username")))) {
            ...
            <div class="container">
                <div class="row">
					...
					try{
						...
						String sql ="select * from usertb where user_id="+userID+";";
					...
					%>
                        ...
                        <form action="usercontrol" method="post">
                            ...
                            <div class="form-group">
                                <input class="form-control input-box" type="text" name="email" value="<%=resultSet.getString("email")%>" placeholder="E-mail" autocomplete="off">
                            </div>
							
							<!-- Enter role -->                            
                            <div class="form-group">
                            	<select class="custom-select" name="role" required>
  									<option selected value="<%=resultSet.getString("role")%>">Select a Role</option>
                            ...
                            <!-- Enter username -->
                            <div class="form-group">
                                <input class="form-control input-box" type="text" name="username" value="<%=resultSet.getString("username")%>" placeholder="Username" autocomplete="off">
                            </div>
                            
                            <!-- Enter password -->
                            <div class="form-group">
                                <input class="form-control input-box" type="password" name="password" value="<%=resultSet.getString("password")%>" placeholder="Password" autocomplete="off">
                            </div>

		                    <!-- Form Group -->
                            <div class="form-group text-center">
                                <button class="btn btn-main btn-effect" type="submit" name="btnUpdateUser" value="updatecelebrity">Update User</button>
                                <button class="btn btn-main btn-effect" type="submit" name="btnDeleteUser" value="deletecelebrity">Delete User</button>
                            </div>

...
<c:forEach var="celebrity" items="${celebrity}">
			<c:set var="id" value="${celebrity.id}"/>
			<c:set var="name" value="${celebrity.name}"/>
			<c:set var="biography" value="${celebrity.biography}"/>
			<c:set var="dateOfBirth" value="${celebrity.dateOfBirth}"/>
			<c:set var="gender" value="${celebrity.gender}"/>
			<c:set var="country" value="${celebrity.country}"/>
			<c:set var="posterImage" value="${celebrity.posterImage}"/>
			<c:set var="bannerImage" value="${celebrity.bannerImage}"/>
		</c:forEach>
<!DOCTYPE html>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="celeb-img">
                            <img src="media/celebrities/posters/${posterImage}" alt="">
                        </div>
                    </div>
                                ...
                                <div class="tab-pane fade active show" id="bio" role="tabpanel" aria-labelledby="bio-tab" aria-expanded="false">
                                    ...
                                    <div class="bio-details">
                                        <ul class="bio-wrapper">
                                            <li><h6>Date of Birth:</h6>${dateOfBirth}</li>
                                            <li><h6>Gender:</h6>${gender}</li>
                                            <li><h6>Country:</h6>${country}</li>
                                            <%
                            if (session.getAttribute("sessionRole") != null) {
            						String sessionRole = (String) session.getAttribute("sessionRole");
            						if(sessionRole!="u"){
            					%>
                                            <li><a href="${pageContext.request.contextPath}/managecelebrity.jsp?celebrity_id=${id}" class="btn btn-main btn-effect">Manage Content</a></li>
                                        <%
            						}
                            }
                            %>
